        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="space-y-1">
                    ...
                    <input type="date" value={formData.入住日期} onChange={e => setFormData({ ...formData, 入住日期: e.target.value })} className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none" required />
                </div>
                <div className="space-y-1">
                    <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider">{t('check_out_date')}</label>
                    <input type="date" value={formData.退房日期} onChange={e => setFormData({ ...formData, 退房日期: e.target.value })} className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none" required />
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                    ...
                    <input type="text" value={formData.飯店} onChange={e => setFormData({ ...formData, 飯店: e.target.value })} className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none" placeholder="Hotel Name" required />
                </div>
            </div>
